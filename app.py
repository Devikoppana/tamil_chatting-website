...
def add_user():
    ...
    if '@' not in email or '.' not in email:
        print("Validation failed: Invalid email format")  # Debugging
    ...
    print("Session after register:", session)  # Debugging
...
def handle_disconnect():
    ...
    if user_id and user_id in online_users:
        ...
        # 🔥 Send system message on disconnect
        emit('chat_message', {
            "sender": "System",
            "message": f"{user_name} has left the chat room.",
            "system": True
        }, broadcast=True)
